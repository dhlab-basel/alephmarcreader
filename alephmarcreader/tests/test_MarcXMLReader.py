...
class TestMethods(unittest.TestCase):
    def test_author(self):
        marcxml_rd = AlephMarcXMLReader('alephmarcreader/tests/sample_data/MarcXML/000055275.xml')
    ...
    def test_get_standardized_date(self):
        ...
        std_date = marcxml_rd.get_standardized_date()
        ...
        marcxml_rd = AlephMarcXMLReader('alephmarcreader/tests/sample_data/MarcXML/000234529.xml')
    ...
    def test_get_shelfmark(self):
        ...
        marcxml_rd = AlephMarcXMLReader('alephmarcreader/tests/sample_data/MarcXML/000054774.xml')
    ...
    def test_get_footnote(self):
        ...
        footnote = marcxml_rd.get_general_remarks()
    ...
    def test_recipient_with_multiple_roles(self):
        marcxml_rd = AlephMarcXMLReader('alephmarcreader/tests/sample_data/MarcXML/000059794.xml')
    ...
    def test_get_external_link(self):
        marcxml_rd = AlephMarcXMLReader('alephmarcreader/tests/sample_data/MarcXML/000307927.xml')

        external_links = marcxml_rd.get_emanuscripta_doi()
    ...
    def test_get_pyhsical_description(self):
        marcxml_rd = AlephMarcXMLReader('alephmarcreader/tests/sample_data/MarcXML/000059552.xml')

        physical_desc = marcxml_rd.get_physical_description()
    ...
    def test_get_content_summary(self):
        ...
        content = marcxml_rd.get_content_summary()
    ...
    def test_get_mentioned_organisation(self):
        ...
        mentioned_organisation = marcxml_rd.get_mentioned_organisation()
    ...
    def test_get_recipient_organisation(self):
        marcxml_rd = AlephMarcXMLReader('alephmarcreader/tests/sample_data/MarcXML/000056870.xml')

        mentioned_organisation = marcxml_rd.get_recipient_organisation()
    ...
    def test_get_supplement_remarks(self):
        ...
        suppl_remarks = marcxml_rd.get_supplement_remarks()
    ...
    def test_get_document_state(self):
        ...
        doc_states = marcxml_rd.get_document_state()
    ...
    def test_get_original_date_and_place(self):
        ...
        orig_date = marcxml_rd.get_original_date_and_place()
    ...
    def test_get_references_to_related_entries(self):
        ...
        references = marcxml_rd.get_references_to_related_entries()
    ...
    def test_get_bibliographic_references(self):
        ...
        doc_states = marcxml_rd.get_bibliographic_references()
